...
export const originalSiteData = {
  institution: {
    name: "Afra K Fashion School",
    tagline: "Training The Next Generation Of Fashion Innovators In Ghana",
    motto: "LEARN. PRACTICE. BECOME.",
    foundedYear: "2016",
    accreditation: "Affiliated to GHANA TVET SERVICES (NVTI) & Council for Technical and Vocational Educational Training (CTVET), Registered with Registrar General's Department of Ghana",
    address: "L154, Otinshie GBE RD., GD-133-4338, Ogbojo (Near ARS Roundabout), East Legon, Accra, Ghana",
    phones: ["0240187828", "0507653685"],
    intlPhones: ["+233 24 018 7828", "+233 50 765 3685"],
    email: "afrakfashionschoolgh@gmail.com",
    applicationFee: {
      GHS: 200,
      USD: 20
    }
  ...
  managementAndFaculty: [
    {
      id: "lesley-aidoo",
      name: "Lesley Aidoo Mensah",
      role: "Founder, CEO & Master Couturier",
      ...
      coursesTaught: ["1-Year Foundational Programme", "Private Haute Couture Masterclasses"]
    },
    {
      id: "bethel-gbewonyo",
      name: "Bethel Mawuenam Gbewonyo",
    ...
    },
    {
      id: "amoo-ayodeji",
      name: "Amoo Ayodeji",
      role: "Pattern Drafting & Garment Construction Facilitator",
  ...
  ourStory: {
    heading: "Shaping the Future of Fashion",
    paragraphs: [
      "Afra K Fashion School is a private fashion school that is focused on training a generation of ethical fashion Entrepreneurs through a Transformational Training approach. The Institute is registered with the Registrar General’s Department of Ghana and registered under the Council for Technical and Vocational Educational Training (CTVET), affiliated with Ghana TVET Services (NVTI).",
      "Afra K Fashion School is committed to training and developing the next generation of ethical fashion entrepreneurs through a strong critical and analytical thinking curriculum enhanced with practical application in the arts environment.",
      "Afra K Fashion School believes Ghana is a strategic destination for global business. Thus, there is the need to prepare and equip locally trained, successful, and globally competent leaders who will work in and manage industries successfully."
    ]
  },

  missionVision: {
    statement: "Afra K Fashion School is a forward-thinking and excellence-driven institution, deeply committed to creativity, professional discipline, and responsible fashion practice. We combine global perspective with hands-on rigor, while upholding strong values of integrity, sustainability, and positive community impact.",
    vision: "Afra K Fashion School’s vision is to educate a generation of ethical fashion entrepreneurs and excellent leaders who are committed to the application of knowledge for the transformation of the global society.",
    mission: "Afra K Fashion School’s mission is to inspire and train a new generation of ethical fashion entrepreneurs, especially the youth to acquire entrepreneurial and vocational skills to stimulate job creation."
  },
